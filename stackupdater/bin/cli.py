...
class Cli(object):
    ...
    def __init__(self, base_path):
        ...
        parser.add_argument('param', nargs='?', help='Custom recipe directory or gist ID to download recipe')
    ...
    def get(self):
        ...
        if len(self.__cli_args.gist_id) > 0: #ID of Gist not empty
            recipe_downloader = Downloader(self.__base_path, self.__cli_args.param)
